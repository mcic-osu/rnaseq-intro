...
- [Avoid being prompted for your password](#avoid-being-prompted-for-your-osc-password)
...
- [Git for Windows](https://git-scm.com/download/win),
  which comes with a Unix (Bash) shell.
  To install this, download it from the link above and 
...
open a terminal application and input the command `ssh <username>@<hostname>`, where:
...
1.  **_On your own computer_, generate a public-private SSH key-pair:**
...
2.  **_On your own computer_, transfer the public key to OSC's clusters:**
...
at OSC directly,
you don't necessarily need to use the VS Code Server in OSC OnDemand.
