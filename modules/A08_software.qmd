...
As we briefly [saw earlier for FastQC](./A06_overview.html#running-a-cli-program-interactively),
...
the most foolproof way to activate a conda environment is to use **`source activate`**
...
because the conda activation procedure can otherwise result in "unbound variable"
errors.
:::
