...
[using the SLURM job scheduler](A10_slurm.qmd).
...
The session [Compute Jobs with Slurm](A10_slurm.qmd) is dedicated to this topic.
:::
...
- [Submitting batch jobs using the SLURM scheduler](A10_slurm.qmd)
