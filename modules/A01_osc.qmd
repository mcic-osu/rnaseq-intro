...
[loading and installing software at OSC](A08_software.qmd) and
[using the SLURM job scheduler](A09_slurm.qmd).
...
The session [Compute Jobs with Slurm](A09_slurm.qmd) is dedicated to this topic.
:::
...
- Using specific "**Interactive Apps**" (GUI-based programs):
  ...
  - _RStudio_ (TBA)
- [Loading and installing command-line software at OSC](A08_software.qmd)
- [Submitting batch jobs using the SLURM scheduler](A09_slurm.qmd)
