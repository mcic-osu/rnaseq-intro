...
Make sure you log looks similar.
...
(the `-e` option to `echo` will allow us to insert an extra new line with `\n`,
...
Now that we're succesfully looping over our files,
we can submit a batch job in every iteration:
